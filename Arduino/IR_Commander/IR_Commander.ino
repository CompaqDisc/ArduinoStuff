...
Raw IR commander
 ...
 This is a slightly modified version of Adafruit's
 IR detector sketch.  ircodes.h contains the definitions
 for the Play, Fast Forward, and Rewind button's on Vetco's
 IR remote (part number VUPN6334 at Vetco.net);
 
 This sketch works with the ir detector bundled with the remote
 in VUPN6334. It also works with Vetco's IR detector (Vetco part 
 number VUPN5920).
...
void loop(void) {
  ...
  else if (IRcompare(numberpulses, PowerSignal,sizeof(PowerSignal)/4)) {
